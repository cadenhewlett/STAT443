...
We recall that the third plot of `tsdiag` are the $p$-values of the Ljung-Box Version of the Portmanteau Lack-of-Fit test, where informally the following hypotheses are being compared:
