...
$$
f(\omega) = \frac{1}{\pi}\Big(62 - 70 \cos(\omega) + 12\cos(2w) \Big), \hspace{0.5cm} \omega \in (0, 1)
$$
...
We will begin with computing the autocovariance function $\gamma(h)$ at lag  $h = 0$, then at $h = 1$, $k = 2$ and finally $k > 2$.
...
$$
\begin{aligned}
\int_0^{\pi}f(\omega)\cos(h \omega) \text{d}\omega &= \int_0^{\pi} \bigg[  \frac{1}{\pi}\Big(a - b \cos(\omega) + c\cos(2w) \Big)\bigg]\cos(h \omega) \text{d}\omega \\
