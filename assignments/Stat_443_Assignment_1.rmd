...
The serial dependence of the de-seasonalzied data seems to be predominantly white noise. 
We know that if the sample acf values tend to be withing $\pm 2 / \sqrt{n}$, this is indicative of serial dependence that is simply *iid* noise.
...
$$
\sum_{i = 0}^{h_\text{max}} \mathbbm{1}(|\rho(h_i)| \geq 2/\sqrt{n})
$$
