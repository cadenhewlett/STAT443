...
$$
We hence let ${\mathfrak{X}}$ be the set of all models fitted such that the $p$-th entry of ${\mathfrak{X}}$ is the model fitted $\widehat{X}^{\,p}_t$, i.e.
$$
{\mathfrak{X}} = \Big\{\widehat{X}^{\,\underset{0}{}}_t, \widehat{X}^{\,\underset{1}{}}_t, \dots, \widehat{X}^{\,\underset{N/2}{}}_t\Big\}
$$
```{r}
tvals = 1:N
```
