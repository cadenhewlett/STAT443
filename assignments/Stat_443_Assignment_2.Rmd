...
p <- ggplot(plotDF) + theme_bw() +
  ...
  scale_shape_manual(values = c("Theoretical" = 4, "Observed" = 3),
                     name = "ACF Type") +
  theme(
...
\end{aligned}
$$
Therefore, our restrictions on $a$ are that $a \neq 0$ and $|a| > 1/2$.

In other words, these roots are redundant since it must be the case that $a \in \mathbb{R}$ as per the problem description.
