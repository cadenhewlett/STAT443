...
$$
We start with evaluating the first term in the sum. It is crucial to remember that each $\psi$ is itself an infinite-order polynomail, so we must write them as:
$$
\begin{aligned}
