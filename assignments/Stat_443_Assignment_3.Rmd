...
plot(nino_filtered)
acf_filtered = acf(nino_filtered, lag.max = 30, plot = T)$acf
```
```{r}
# ar(1) vs. ar(6)
pacf_filtered = pacf(nino_filtered, lag.max = 30, plot = T)$acf
```
```{r}
# TODO: AR(1) and AR(6) are the two candidate models
```
...
fit2 = arima(nino_filtered, order = c(1, 0, 0)) # -278.9
